			...
			<aside class="col-md-3">
				...
				<div class="data_list">
					...
					<div class="search_form">
						<form class="from-inline" action="${ctx}/search.shtml" role="search" onsubmit="return checkData()">
				...
				<div class="data_list">
					...
					<div class="user_image">
						<img src="${ctx}/images/avatar/${blogger.imageUrl }" alt="头像" />
					</div>
				...
				<div class="data_list">
					...
					<div class="datas">
						<ul>
							...
							<li>
			                    <a href="${ctx}/blog.shtml?cat=${blogType.typeId}">${blogType.typeName }</a>
							...
							<li>
			                    <a href="javascript:;" onclick="showOtherType()" id="showOtherType">更多...</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="data_list">
					...
					<div class="datas">
						...
						<c:forEach var="blog" items="${dateRankList }">
							<li>
						        <a href="${ctx}/blog.shtml?month=<fmt:formatDate value="${blog.releaseDate }" type="date" pattern="yyyyMM"/>">${blog.releaseDateStr }</a>
					...
					<div class="datas">
						...
						<c:forEach var="blog" items="${readingRankList }" varStatus="index">
							<li class="ellipsis">
							    ...
							    <a href="${ctx}/blog/articles/${blog.id }.shtml" title="${blog.title }">${blog.title }</a>
							</li>
						</c:forEach>
						</ul>
					</div>
				...
				<div class="data_list">
					...
					<div class="datas">
						...
						<c:forEach var="link" items="${linkList }">
							<li>
				    		     <a href="${link.linkUrl }" rel="external nofollow" target="_blank">${link.linkName }</a>
					        </li>
						</c:forEach>
						</ul>
					</div>
